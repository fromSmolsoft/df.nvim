...
return {
    ...
    @return string either "mac","win" or "linux"
    ]]
    get_os = function()
    ...
    @return string path to user home directory
    ]]
    ...
    @return true if file exists, false if file doesn't exists or can't be open for reading
    ]]
